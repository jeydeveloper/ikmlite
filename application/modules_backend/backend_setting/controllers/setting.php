...
class Setting extends MY_Admin {
	...
	private $_module_controller = 'backend_setting/setting/';
	...
	private function get_show_column() {
		$column_list = array(
			...
			array(
				'title_header_column' 	=> 'Setting',
				'field_name' 			=> $this->_table_field_pref . 'setting',
				'no_order'				=> 1,
			),
            array(
                'title_header_column' 	=> 'Nilai',
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			...
			array(
				...
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" data-parsley-minlength="1" class="form-control" placeholder="Setting..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
            ...
            array(
                ...
                'db_process'	=> true,
                'input_type'	=> 'text',
                'input_attr'	=> 'type="text" data-parsley-minlength="1" class="form-control" placeholder="Nilai..."',
                'required'		=> 'required',
                'data_source'	=> '',
                'data_edit'		=> array(
                    'db_process'	=> true,
