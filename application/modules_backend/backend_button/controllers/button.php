...
class Button extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_button/button/';
	private $_table_name 		= 'button';
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			array(
				'db_field' 		=> $this->_table_field_pref . 'butt_id',
				'db_pk' 		=> true,
				'db_process'	=> false,
				'data_edit'		=> array(
					'db_process'		=> false,
			...
			array(
				'label' 		=> 'button',
				'db_field' 		=> $this->_table_field_pref . 'butt_data',
				'db_process'	=> true,
				'input_type'	=> 'text',
				'input_attr'	=> 'type="text" data-parsley-minlength="1" class="form-control" placeholder="Data..."',
				'required'		=> 'required',
				'data_source'	=> '',
				'data_edit'		=> array(
					'db_process'	=> true,
            ...
            array(
                'label' 		=> 'button',
                'db_field' 		=> $this->_table_field_pref . 'butt_value',
                'db_process'	=> true,
                'input_type'	=> 'text',
                'input_attr'	=> 'type="text" data-parsley-minlength="1" class="form-control" placeholder="Value..."',
                'required'		=> 'required',
                'data_source'	=> '',
                'data_edit'		=> array(
                    'db_process'	=> true,
            ...
            array(
                'label' 		=> 'button',
                'db_field' 		=> $this->_table_field_pref . 'butt_status',
                'db_process'	=> true,
                'input_type'	=> 'text',
                'input_attr'	=> 'type="text" data-parsley-minlength="1" class="form-control" placeholder="Status..."',
                'required'		=> 'required',
                'data_source'	=> '',
                'data_edit'		=> array(
                    'db_process'	=> true,
