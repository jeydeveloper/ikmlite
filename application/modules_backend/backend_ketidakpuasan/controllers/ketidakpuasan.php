...
class Ketidakpuasan extends MY_Admin {
	private $_template 			= 'template_admin/main';
	private $_module_controller = 'backend_ketidakpuasan/ketidakpuasan/';
	private $_table_name 		= 'ketidakpuasan';
	private $_table_field_pref 	= '';
	private $_table_pk 			= 'ktps_id';
	private $_model_crud 		= 'ketidakpuasan_model';

	private $_page_title 		= 'IKM Lite : Admin Ketidakpuasan';
	private $_page_content_info	= array(
		'title' => 'Data Ketidakpuasan',
		'desc' 	=> 'List Ketidakpuasan',
	);
	...
	private function get_show_column() {
		$column_list = array(
			array(
				...
				'field_name' 			=> $this->_table_field_pref . 'ktps_id',
				'show_no_static' 		=> true,
				'no_order'				=> 0,
			),
			array(
            ...
            array(
                ...
                'field_name' 			=> $this->_table_field_pref . 'ktps_keterangan',
                'no_order'				=> 2,
            ),
            array(
	...
	private function get_input_field_new($data_value = array()) {
		$data_input = array(
			array(
				'db_field' 		=> $this->_table_field_pref . 'ktps_id',
				'db_pk' 		=> true,
				'db_process'	=> false,
				'data_edit'		=> array(
					'db_process'		=> false,
			...
			array(
				'label' 		=> 'Nama',
				'db_field' 		=> $this->_table_field_pref . 'ktps_nama',
				'db_process'	=> true,
				'input_type'	=> 'text',
